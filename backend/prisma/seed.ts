...
async function main() {
  ...
  console.log('Employee 1: employee@demo.com  (John Doe → ABC Corp)');
  console.log('Employee 2: jigar@demo.com     (Jigar Patel → Virtual Height)');
  console.log('Employee 3: sarah@demo.com     (Sarah Johnson → ABC Corp)');
