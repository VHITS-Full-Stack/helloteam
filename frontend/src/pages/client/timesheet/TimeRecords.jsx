...
const TimeRecords = () => {
  ...
  const deriveDisplayStatus = (rec) => {
    ...
    const hasPendingAutoOT = otEntries.some((ot) => ot.status === "PENDING" && ot.isAutoGenerated);
    if (hasPendingAutoOT) return "unapproved_ot";
