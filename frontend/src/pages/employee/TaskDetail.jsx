...
const STATUS_CONFIG = {
  TODO: { label: 'To Do', color: 'bg-gray-100 text-gray-700', ring: 'ring-gray-300', dot: 'bg-gray-400', icon: Circle },
  IN_PROGRESS: { label: 'In Progress', color: 'bg-blue-50 text-blue-700', ring: 'ring-blue-300', dot: 'bg-blue-400', icon: Clock },
  DONE: { label: 'Done', color: 'bg-green-50 text-green-700', ring: 'ring-green-300', dot: 'bg-green-500', icon: CheckCircle2 },
};
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              {task.isPersonal ? 'Personal Task' : task.client?.companyName || 'Task'}
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            <table className="w-full text-sm">
              <tbody className="divide-y divide-gray-100">
                ...
                <tr>
                  <td className="px-6 py-3 text-gray-500">{task.isPersonal ? 'Type' : 'Client'}</td>
                  <td className="px-6 py-3 text-sm font-medium text-gray-900">{task.isPersonal ? 'Personal Task' : task.client?.companyName || '—'}</td>
                </tr>
                <tr>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none pr-9 w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500"
                >
