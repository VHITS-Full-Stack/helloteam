      ...
      {activeTab === "holidays" && (
        <Card padding="md">
          ...
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-500">
              No holidays declared for {holidayYear}. Click "Add Holiday" to
              create one.
            </div>
          )}
        </Card>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) =>
                    setHolidayForm({ ...holidayForm, clientId: e.target.value })
                  }
                  className="input w-full appearance-none pr-9"
                >
          ...
          <div>
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setHolidayForm({ ...holidayForm, isPaid: e.target.checked })
                }
                className="rounded border-gray-300"
              />
            ...
            <p className="text-xs text-gray-500 mt-1">
              {holidayForm.isPaid
                ? "Employee will be paid for this day off"
                : "Unpaid day off"}
            </p>
          </div>
        </div>
